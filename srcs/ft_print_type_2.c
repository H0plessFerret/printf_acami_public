...
/*   Updated: 2021/04/25 18:10:43 by acami            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	return (ft_put_abs_nbr_base(*(long long int *)elem, "0123456789",
			mask));
}

int	ft_print_uint(void *elem, t_mask *mask)
{
	return (ft_put_unsignednbr_base(*(unsigned long long *)elem, "0123456789",
			mask));
}
